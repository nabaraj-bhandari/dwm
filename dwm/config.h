...
static const char *fonts[] 			= {"SF Pro Rounded:Regular:size=12","JoyPixels:pixelsize=16:antialias=true:autohint=true"};
static const char dmenufont[]       = "SF Pro Rounded:size=12";
